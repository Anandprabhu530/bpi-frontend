      ...
      <div className="basis-1/3">
        ...
        <div className="flex gap-4 flex-col">
          ...
          <div>
            ...
            <input className="w-[300px] p-2 border border-neutral-800 outline-none rounded-md bg-neutral-900" />
          </div>
        </div>
        <div className="w-[300px] bg-neutral-900 h-[100px] text-white rounded-md mt-4">
          Below
        </div>
      </div>
    </div>
